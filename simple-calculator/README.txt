...
You can provide data for calculator manually, use default input.txt file or provide path to your own txt file or fetch data from rest api.
For result, you can select display in console, write to provided previously file, both method or save to Rest API if the data comes from API.
...
add another operators with numbers to your calculations (divide 2; subtract 10.5)
