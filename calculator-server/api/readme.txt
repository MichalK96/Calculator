...
curl -X POST -H "Content-Type: application/json" -d "{\"userId\": \"exampleUserId1\", \"name\": \"exampleName1\", \"expressions\": [{\"number\": 5, \"operator\": \"ADD\"}, {\"number\": 3, \"operator\": \"MULTIPLY\"}, {\"number\": 2, \"operator\": \"DIVIDE\"}, {\"number\": 11, \"operator\": \"APPLY\"}]}" http://localhost:8080/api/math-operations
